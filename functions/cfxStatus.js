...
module.exports = async (client) => {
  const channelId = '1300820805621518427'; // Replace with the target channel ID
  const onlineEmoji = '<a:online_emoji:1300822410886643723>'; // Replace with your animated online emoji
  const offlineEmoji = '<a:offline_emoji:1300822432952746077>'; // Replace with your animated offline emoji
